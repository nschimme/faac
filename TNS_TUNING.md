...
- **Justification**: Balanced at 0.45 based on agent-led corpus sweeps (covering 0.05 to 0.55). Integrated with the current branch's TNS and bandwidth optimizations, this value achieves a stable MOS balance and significant throughput recovery compared to lower thresholds.
...
- **Justification**: Standard proportions that balance audio fidelity and bitrate accuracy.
...
- **Purpose**: Scales the noise floor gate for short blocks.
- **Justification**: Provides a more aggressive noise gate for transients to focus bit allocation on high-energy signal components.
...
- **Justification**: Clamps the peak energy ratio at -23 dB as a secondary safety net for tonal components.

## Feature Sweep Results (Summary)

| Configuration | VoIP Avg MOS | VSS Avg MOS | Music Low Avg MOS | Overall MOS |
| :--- | :---: | :---: | :---: | :---: |
| **nf0.45_integrated** | **3.65** | **4.20** | **3.24** | **3.91** |
