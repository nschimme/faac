...
#define PEAK_ENERGY_WEIGHT     0.40f    // tonal (peak-energy) share of the remainder
#define SHORT_BLOCK_TIGHTEN    0.42f    // short blocks get a tighter target per unit of energy
