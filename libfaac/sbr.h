...
/* Frames without a transient get two envelopes from here up: the second
 * follows the level through the frame, which beats spending the bits on the
 * core once there are 17-18 kbps per channel, not at 16. */
