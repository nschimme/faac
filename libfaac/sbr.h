...
#define SBR_PS_BANDS                    10  /* 10 parameter bands (coarse mode) */
#define SBR_PS_IID_LEVELS               15  /* IID quantizer: 15 levels (-7..+7) */
#define SBR_PS_ICC_LEVELS               8   /* ICC quantizer: 8 levels (0..7) */
#define SBR_PS_ICC_MAX_INDEX            (SBR_PS_ICC_LEVELS - 1)
#define SBR_PS_ICC_SIGNED_BANDS         5   /* Signed ICC for lower bands (0..4) */
#define SBR_PS_MAX_DOWNMIX_GAIN         (2.0f) /* +6 dB max downmix compensation */
