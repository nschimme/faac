...
/* Internal object-type values for the HE-AAC path. LC (LOW=2) lives in the
 * public <faaccfg.h>; these mirror the MPEG-4 AOT numbers exposed publicly as
 * FAAC_OBJ_* in <faac_encoder.h>. HE-AAC is offered only through the modern
 * API, so they are intentionally NOT part of the frozen legacy <faaccfg.h>. */
#ifndef AUTO
#define AUTO   0   /* let the library pick LC or HE-AAC from the bitrate */
#endif
#ifndef HE_V1
