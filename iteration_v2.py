...
# it33: Increase both
run_iteration('it33', 10000, 19000)
# it34: Increase 32k only
run_iteration('it34', 10000, 18000)
# it35: Increase 64k only
run_iteration('it35', 8000, 19000)
# it36: Decrease both
run_iteration('it36', 7000, 16000)
